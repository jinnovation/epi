...
- [[#data-structures-and-algorithms][Data Structures and Algorithms]]
  ...
  - [[#14-binary-search-trees][14 Binary Search Trees]]
    - [[#141-test-if-a-binary-tree-satisfies-the-bst-property][14.1 Test if a binary tree satisfies the BST property]]
  - [[#15-recursion][15 Recursion]]
    - [[#151-tower-of-hanoi][15.1 Tower of Hanoi]]
  - [[#16-dynamic-programming][16 Dynamic Programming]]
    - [[#in-progress-161-count-the-number-of-score-combinations][IN-PROGRESS 16.1 Count the number of score combinations]]
...
*** TODO 12.2 Is an anonymous letter constructible?

    Write a program which takes text for an anonymous letter and text for a
    magazine and determinest if it is possible to write the anonymous letter
...
*** TODO 13.1 Compute the intersection of two sorted arrays
...
*** DONE 14.1 Test if a binary tree satisfies the BST property
...
*** IN-PROGRESS 16.1 Count the number of score combinations
