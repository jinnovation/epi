...
- [[#data-structures-and-algorithms][Data Structures and Algorithms]]
  ...
  - [[#stacks-and-queues][Stacks and Queues]]
    ...
    - [[#test-a-string-over--for-well-formedness][Test a string over "{,},(,),[,]" for well-formedness]]
...
*** DONE Test a string over "{,},(,),[,]" for well-formedness
...
*** DONE Test if a binary tree satisfies the BST property
