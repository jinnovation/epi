...
- [[#data-structures-and-algorithms][Data Structures and Algorithms]]
  ...
  - [[#binary-trees][Binary Trees]]
    ...
    - [[#reconstruct-a-binary-tree-from-traversal-data][Reconstruct a binary tree from traversal data]]
...
*** TODO Test if a binary tree is symmetric                                 :C2:
...
*** TODO Reconstruct a binary tree from traversal data                      :C2:
